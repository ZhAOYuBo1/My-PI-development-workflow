import { findFirstMatchForNames } from "./common.ts";
...
export function compileWildcardPatterns<TState>(patterns: Record<string, TState>): CompiledWildcardPattern<TState>[] {
