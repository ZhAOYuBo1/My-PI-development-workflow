...
import { createPermissionSystemCommandHandler, PERMISSION_SYSTEM_COMMAND_DESCRIPTION } from "./common.ts";
import type { PermissionSystemExtensionConfig } from "./extension-config.ts";
