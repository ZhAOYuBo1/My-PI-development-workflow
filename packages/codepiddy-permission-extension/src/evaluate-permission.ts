...
import { compileWildcardPattern } from "./wildcard-matcher.ts";
...
export function evaluatePermission(tool: string, command: string, ...rulesets: unknown[]): PatternPermissionEvaluation {
